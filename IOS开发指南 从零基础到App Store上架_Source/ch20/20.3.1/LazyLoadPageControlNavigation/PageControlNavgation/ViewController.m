...
- (void)viewDidLoad
{
    ...
    height = result.height - statusBarHeight- 40;
    ...
    self.page1.frame = CGRectMake(0.0f, 0.0f, 320.0f, height);
...
-(void) loadImage:(int) nextPage
{
    ...
    if (nextPage == 1 && self.page2 == nil) {
        ...
        self.page2.frame = CGRectMake(320.0f * nextPage, 0.0f, 320.0f, height);
    ...
    if (nextPage == 2 && self.page3 == nil) {
        ...
        self.page3.frame = CGRectMake(320.0f * nextPage, 0.0f, 320.0f, height);
    ...
    if (nextPage == 3 && self.page4 == nil) {
        ...
        self.page4.frame = CGRectMake(320.0f * nextPage, 0.0f, 320.0f, height);
